...
\address{%
$^{1}$ \quad School of GeoSciences, University of Edinburgh, \hl{Edinburgh}, UK; \hl{casey.ryan@ed.ac.uk (C.M.R.); Thom.Brade@ed.ac.uk (T.K.B.); kyle.dexter@ed.ac.uk (K.G.D.)}\\ %Please add the post code. We added e-mails from redmine, please confirm.
...
%\\[-1.8ex]\midrule 
%\midrule \\[-1.8ex] 
 & \multicolumn{4}{c}{\hl{\textit{\textbf{Dependent Variable:}}}} \\  %Is italic necessary?
\cmidrule{2-5} 
%\\[-1.8ex]
...
\newblock {\em Vegetation Survey of the Woodlands of {Hu{\'i}la Province}};
 \hl{Gottingen, Germany; Windhoek, Namibia},  2018; doi:10.7809/b-e.00355. %Please add the publisher.
...
\hl{Available online:} %Please add the website.
...
\newblock {\em Protected Planet: The World Database on Protected Areas (WDPA)}.
   2019. \hl{Available online:} %Please add the website.
